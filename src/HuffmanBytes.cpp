...
std::map<std::byte, int> HuffmanBytes::count_occurences(const ByteVector& plainText){
...
void HuffmanBytes::print_huffman(Node::node* root, ByteVector String){
    if(!root) return;
...
std::priority_queue<Node::node*, std::vector<Node::node*>, compareNodes> HuffmanBytes::build_min_heap(const ByteVector& PlainText){
...
void HuffmanBytes::build_huffman_tree(const ByteVector& PlainText){
...
void HuffmanBytes::build_huffman_codes(Node::node* root, ByteVector String){
    if(!root) return;
...
ByteVector HuffmanBytes::mapCharToCode(const ByteVector& plainText){
    ByteVector result;
...
ByteVector HuffmanBytes::encode_string_huffman(const ByteVector& PlainText){
...
ByteVector HuffmanBytes::decode_string_huffman(const ByteVector& CompressedString){
...
ByteVector HuffmanBytes::encode(const ByteVector& PlainText){
    return encode_string_huffman(PlainText);
}

ByteVector HuffmanBytes::decode(const ByteVector& EncodedString){
